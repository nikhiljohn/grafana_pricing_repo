      ...
      <div className="border-b border-slate-200 px-6 py-5">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-semibold text-slate-800">SecOps Intelligence</h1>
              <p className="text-sm text-slate-500">
                Security posture with remediation memory — every finding has context from past resolutions
              </p>
            </div>
          </div>
