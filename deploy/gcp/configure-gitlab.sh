...
json_field() { printf '%s' "$1" | tr ',' '\n' | grep -m1 "\"$2\":" | sed -E 's/.*"'"$2"'": *"?([^",}]*)"?.*/\1/'; }

# ── Step 1 · Token and permissions ───────────────────────────────────────────

bold "── Step 1/4 · Token and permissions ─────────────────────────────────────"
...
bold "── Step 2/4 · Default branch and Auto DevOps ────────────────────────────"
...
bold "── Step 3/4 · Branch protection on 'main' ───────────────────────────────"
